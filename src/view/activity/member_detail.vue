		...
		<Row>
			...
			<Card>
				...
				<div>
					...
					<img src="http://images.ufutx.com/201812/26/e3bda271deea123ba59ae3c5dc2d6657.png" width="24" style="margin-top: 4px" class="float_l" v-if="orgData.sex == 1" alt="男" />
					<img src="http://images.ufutx.com/201812/26/1b8e3141b47f84969b19e931b070e478.png" v-else style="margin-top: 4px" class="float_l" width="24" />
					<span class="_bold" style="font-size: 16px;float: left;margin-top: 4px;" v-if="orgData.profile">（推荐人：{{orgData.from_user_name}}）</span>
					<div style="clear: both"></div>
				</div>
				<div style="clear: both"></div>
				<Table :columns="columns" :data="information" :show-header="false" :border="false" style="margin-top: 26px;" size="large"></Table>
			</Card>
			</Col>
			<Col span="11" style="margin: 22px">
			<Card>
				...
				<Table :columns="columns" :data="information1" :show-header="false" :border="false" style="margin-top: 26px;" size="large"></Table>
