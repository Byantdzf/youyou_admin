                    ...
                    <Row style="margin-top: 20px">
                        ...
                        <Card>
                            ...
                            <div v-for="item,index in matches" class="_bc-list">
                                ...
                                <img src="http://images.ufutx.com/201812/26/459558ae48ecb17fdc143acd2b82b5cf.png" alt=""  height="60px" style="margin: 22px; margin-bottom: 22px;">
                                <span class="_bc-name">{{item.other_user.name}}</span>
                                <img :src="item.other_user.circle_avatar" alt="" width="120px" height="120px">
                                <img v-if="index == 0" src="http://images.ufutx.com/201812/26/21919d6a6b122a9185b638ce67d9250a.png" class="bc-style" />
                                <img v-if="index == 1" src="http://images.ufutx.com/201812/26/336e0ac44ed7d1946f00f4195e5646d3.png" class="bc-style" />
                                <img v-if="index == 2" src="http://images.ufutx.com/201812/26/ca99eaab4a2b5247d0d5f93b1e86ff22.png" class="bc-style" />
                        ...
                        <Col span="10"  v-if="welcome_male_users.length > 0">
                            <Card>
                                <p slot="title" class="card-title" >
                                    <span class="float_l">最佳欢迎</span><img src="http://images.ufutx.com/201812/26/e3bda271deea123ba59ae3c5dc2d6657.png" width="22" class="float_l" alt="男">
                                </p>
                                <div v-for="item,index in welcome_male_users" class="_bc-list">
                                    ...
                                    <img src="http://images.ufutx.com/201812/26/e3bda271deea123ba59ae3c5dc2d6657.png" width="24" class="float_l" v-if="item.sex == 1" alt="男">
                                    <img src="http://images.ufutx.com/201812/26/1b8e3141b47f84969b19e931b070e478.png" v-else alt="女" class="float_l" width="24">
                        ...
                        <Card>
                            <p slot="title" class="card-title" >
                                <span class="float_l">最佳欢迎</span><img src="http://images.ufutx.com/201812/26/1b8e3141b47f84969b19e931b070e478.png" width="22" class="float_l" alt="男">
                            </p>
