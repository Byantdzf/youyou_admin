    ...
    <Row>
      <Card v-if="user_is_admin==1">
        ...
        <div style="display: inline-block;margin-left: 22px;">
          ...
          <!--<dropdown :dropData="redMun" v-on:getGropData="getGropData"  title="请选择红娘"  style="display: inline-block"></dropdown>-->
          ...
          <Button type="primary"  style="margin-left: 8px" @click="setapproved" v-if="is_approved == 0">授权该用户为实名认证用户</Button>
          <Button type="primary"  style="margin-left: 8px;background-image: linear-gradient(to top, #00c6fb 0%, #005bea 100%);" @click="gotoEdit" >编辑用户</Button>
          <Button type="warning"  style="margin-left: 8px" @click="gotoUrl('user_order','user_order_id',id)">用户订单</Button>
      ...
      <Col span="11" style="margin: 22px">
        <Card>
          ...
          <div style="display: inline-block;margin-left: 22px;">
            <Button @click="settNote">备注管理</Button>
          </div>
...
export default {
  ...
  methods: {
    ...
    gotoEdit () {
      ...
      //     content: '此功能正在开发...'
      // });
      let argu = { edit_user_detail_id: this.id }
      this.$router.push({
