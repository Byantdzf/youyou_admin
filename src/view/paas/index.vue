  ...
  <div class="hello">
    <Card>
      <Tabs @on-click="getTab">
        <TabPane :label='title' name="paasDetail">
          <Row style="padding: 12px;">
            ...
            <!--<i-col span="11" offset="2" v-if="id != 0">-->
              <!--<Card :bordered="true">-->
                <!--<Form ref="paasDetail" :model="paasDetail" :label-width="100">-->
                  <!--&lt;!&ndash;<FormItem label="logo" prop="image">&ndash;&gt;-->
                    <!--&lt;!&ndash;<Card>&ndash;&gt;-->
                      <!--&lt;!&ndash;<uploadImage v-on:uploadPictures="uploadLogo" :pic="platform.logo"></uploadImage>&ndash;&gt;-->
                    <!--&lt;!&ndash;</Card>&ndash;&gt;-->
        ...
        <TabPane label='渠道列表' name="paasPlatform" v-if="id != 0" style="height: 200px">
          <div style="overflow: hidden">
            <Button type="primary" @click="channel()" style="margin-bottom: 18px;margin-right: 110px;float: right">新建渠道</Button>
          </div>
          ...
          <Page :total="total" @on-change="handlePage" :page-size="15"
                style="float:right;margin-top:15px;margin-bottom:10px;"></Page>
        </TabPane>
        <TabPane label='同工列表' name="paasUser" v-if="id != 0">
          <Card style="margin-bottom: 20px" v-if="activeTab == 'paasUser' && id != 0">
            <Tabs>
              <TabPane label="添加同工">
                <Input
                ...
                <Page :total="workerTotal" @on-change="workerPage" :page-size="15"
                      style="float:right;margin-top:15px;"></Page>
              </TabPane>
            </Tabs>
          </Card>
